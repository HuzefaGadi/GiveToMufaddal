...
public class CustomWebView extends WebView {
    ...
    protected static final int CAPTURE_RESULTCODE = 2;
    ...
    public void onActivityResult(final int requestCode, final int resultCode, final Intent intent) {
        ...
        } else if (requestCode == CAPTURE_RESULTCODE) {
            if (resultCode == Activity.RESULT_OK) {
                if (mFileUploadCallbackFirst != null && intent != null) {
                    ...
                    mFileUploadCallbackSecond.onReceiveValue(new Uri[]{mContext.getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values)});
                    mFileUploadCallbackSecond = null;
                }
            } else {
                if (mFileUploadCallbackFirst != null) {
    ...
    protected void init(Context context) {
        ...
        databaseDir = filesDir.substring(0, filesDir.lastIndexOf("/")) + DATABASES_SUB_FOLDER;
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(final WebView view, final String url) {
                ...
                if(url!=null && (url.contains("geo:") || url.contains("maps.google.com"))) {
            ...
            public void onLoadResource(WebView view, String url) {
                if (url!=null && url.contains("https://supertest.boldirect.com/api/")) {
                    Log.d("url", "onLoadResource" + url);
                }
                if (mCustomWebViewClient != null) {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
                ...
                if (Build.VERSION.SDK_INT >= 11) {
                    if (mCustomWebViewClient != null) {
                        resourceResponse =  mCustomWebViewClient.shouldInterceptRequest(view, url);
                    } else {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                WebResourceResponse resourceResponse = null;
                if (request!=null && request.getUrl().toString().contains("https://supertest.boldirect.com/api/")) {
                    Log.d("url", "shouldInterceptRequest with request " + request.getUrl().toString());
                }
                if (Build.VERSION.SDK_INT >= 21) {
                    if (mCustomWebViewClient != null) {
                        resourceResponse =  mCustomWebViewClient.shouldInterceptRequest(view, request);
                    } else {
        ...
        super.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                openFileInput(uploadMsg, null, false, null);
            }
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, WebChromeClient.FileChooserParams fileChooserParams) {
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    openFileInput(null, filePathCallback, allowMultiple, fileChooserParams);
    ...
    @SuppressLint("NewApi")
    protected void openFileInput(final ValueCallback<Uri> fileUploadCallbackFirst, final ValueCallback<Uri[]> fileUploadCallbackSecond, final boolean allowMultiple, final WebChromeClient.FileChooserParams fileChooserParams) {
        if (mFileUploadCallbackFirst != null) {
            mFileUploadCallbackFirst.onReceiveValue(null);
        }
        ...
        Intent i = null;
        String[] fileChooserParamsArray = fileChooserParams.getAcceptTypes();
        if (fileChooserParamsArray.length == 1 && fileChooserParamsArray[0].contains("image")) {
            File imageStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "BOLdirect");
            ...
            if (mFragment != null && mFragment.get() != null && Build.VERSION.SDK_INT >= 11) {
                mFragment.get().startActivityForResult(Intent.createChooser(i, getFileUploadPromptLabel()), CAPTURE_RESULTCODE);
            } else if (mActivity != null && mActivity.get() != null) {
                mActivity.get().startActivityForResult(Intent.createChooser(i, getFileUploadPromptLabel()), CAPTURE_RESULTCODE);
            }
        } else {
